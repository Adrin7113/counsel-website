const Landing = () => {
  return (
    <section className="w-full h-screen bg-[url('/landing/hero.png')] bg-center bg-cover flex items-center p-40 relative font-main">
      {/* Slight shade over the background image */}
      <div className="absolute inset-0 w-full h-full bg-black/80"></div>
        {/* Content over the background image */}
      <div className="relative z-10 text-white">
        <h1 className="text-6xl font-light">BUILDING LIVES</h1>
        <h1 className="text-6xl font-light mt-2">BEYOND BOUNDARIES</h1>
        <div className="flex items-center gap-4 mt-8 font-light">
