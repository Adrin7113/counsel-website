...
const SeekHelp = () => {
  return (
    <div className='min-h-[70vh] w-screen bg-white flex flex-col items-center justify-center py-12 p-6 md:p-12 font-main'>
        <h2 className="text-4xl text-center md:text-5xl font-light text-gray-700">{data.title}</h2>
